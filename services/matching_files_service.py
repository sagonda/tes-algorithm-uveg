...
class MatchingFilesService():

    def __init__(self, year, month, day, path_files_Myd03, path_files_Myd021, path_files_Myd35, path_files_CSV):
        self.year              = year
        self.month             = month
        self.day               = day
    ...
    def read_match_files(self, f_Myd03, f_Myd02, f_Myd35):
        ...
        try:
            ...
            list_total_myd03 = [i.split('.')[2] for i in f_Myd03]
